  ...
  return (
    ...
    >
      ...
      >
        <BackgroundGradientAnimation>
          <div className="absolute z-[1]  inset-0 flex items-center justify-center text-white font-bold px-4 pointer-events-none text-3xl text-center md:text-4xl lg:text-7xl">
            <div className="w-full h-full flex justify-center items-center">
              <div className="absolute bottom-[1vh] flex gap-2 justify-center items-center">
                <div className="bg-green-500 rounded-full w-3 h-3 animate-pulse"></div>
                <h1 className="text-lg font-light">Open for new Projects</h1>
              </div>
            </div>
          </div>
        </BackgroundGradientAnimation>
        ...
        <div
          id="letConnectDiv"
          className="flex flex-col gap-[3vw] absolute w-full justify-center items-center top-[40%] scale-[2] rotate-[35deg] translate-y-[100vh]"
        >
          <h1 className=" bg-white px-[2vw] min-w-[70px] hover:bg-transparent hover:border hover:text-white min-h-[70px] flex justify-center items-center rounded-full text-2xl text-black font-normal">
            Let's get Connected{" "}
          ...
          <div
            id="callMailDiv"
            className="opacity-0 z-[20] top-[65%] w-full flex justify-center items-center gap-[2vw]"
          >
            <a
              className="border hover:bg-white hover:text-black duration-500 gap-[1vw] flex min-w-[70px] min-h-[70px] px-[2vw] justify-center text-2xl rounded-full items-center"
            ...
            <a
              ...
              rel="noreferrer"
            >
              <button className="border hover:bg-white gap-[1vw] hover:text-black duration-500 flex min-w-[70px] min-h-[70px] px-[2vw] justify-center text-2xl rounded-full items-center">
            ...
            <a
              ...
              className="border flex hover:bg-white hover:text-black gap-[1vw] duration-200 min-w-[70px] min-h-[70px] px-[2vw] justify-center text-2xl rounded-full items-center"
            >
