     ...
     h-[100vh] overflow-hidden w-[100vw]
      ...
      > */}
        ...
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.4, delay: 10 }}
          className="relative h-[100vh] w-full top-0 right-0 flex justify-center items-center bg-transparent z-40 transition-all"
        >
          {/* <motion.div className="relative md:h-[100vh] h-[70vh] w-full top-0 right-0 flex justify-center items-center bg-transparent z-40 transition-all"> */}
            <Suspense fallback={`this is Loading.....`}>
              <AnimatePresence>
                <motion.div className="md:w-full w-[200vw] absolute">
                  <HeroModel />
                </motion.div>
              </AnimatePresence>
            </Suspense>
